...
const ServiceSelectionModal = ({ isOpen, onClose, onSubmit, services }) => {
    ...
    return (
        <div className={`fixed bg-teal-800 w-3/4 h-full top-0 z-50 left-1/2 transform -translate-x-1/2 transition-opacity duration-300 ${isOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'
            }`}>
            <div className="bg-stone-500 pt-8 px-10 max-h-[90vh] overflow-y-auto">
                ...
                >
                    ...
                    <button
                        type="submit"
                        className="fixed bottom-2 left-1/2 -translate-x-1/2 px-10 py-3 text-xl rounded bg-teal-600 shadow-lg z-50"
                    >
                        Valider
                    </button>
                </form>
